...
//   console.log('Request Type:', req.method);
//   callMarket(function (data) {
//     res.json(data);
//   });
// });
// app.use("/getCurrency", function (req, res, next) {
//   console.log("Get Currency:", req.method);
...
// var urls = {
//   // bitthumb: "https://api.bithumb.com/public/ticker/all",
...
// // setInterval(callAllTicker, 1000);
